...
Add diacritic marks to `str`. `maxmarks` sets the maximum number of diacritic
marks to added to each letter. The `upmarks` range sets the minimum and maximum
number of diacritic marks added above the letter.
"""
